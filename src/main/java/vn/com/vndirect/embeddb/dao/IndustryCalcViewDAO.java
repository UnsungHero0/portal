...
public class IndustryCalcViewDAO extends JdbcDaoSupport {
	...
	private final static String SQL_INSERT_INDUSTRY_CALC_VIEW = "INSERT INTO INDUSTRY_CALC_VIEW(INDUSTRY_CODE, SECTOR_CODE, PE, PB, SCOPE_MAKET_CAP, SCOPE_ASSET, SCOPE_EQUITY, GROWTH_ASSET, GROWTH_REVENUE, ROA, ROE, PROFIT_MARGIN, DEBT_EQUITY, CURRENT_RATIO, EBITDA) "
			+ "VALUES (:INDUSTRY_CODE, :SECTOR_CODE, :PE, :PB, :SCOPE_MAKET_CAP, :SCOPE_ASSET, :SCOPE_EQUITY, :GROWTH_ASSET, :GROWTH_REVENUE, :ROA, :ROE, :PROFIT_MARGIN, :DEBT_EQUITY, :CURRENT_RATIO, :EBITDA)";
	 ...
	 */
	public void insert(IndustryCalcView bean) throws SystemException {
		final String LOCATION = "insert(IndustryCalcView)";
		...
		try {
			...
			OracleDAOHelper.update(this.getDataSource(), SQL_INSERT_INDUSTRY_CALC_VIEW, paramMap);
