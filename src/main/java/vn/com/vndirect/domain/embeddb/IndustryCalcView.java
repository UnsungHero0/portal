...
public class IndustryCalcView implements java.io.Serializable {
	...
	/** default constructor */
	public IndustryCalcView() {
	}

	/** minimal constructor */
	public IndustryCalcView(String industryCode, String sectorCode) {
		this.industryCode = industryCode;
		this.sectorCode = sectorCode;
	}

	/** full constructor */
	public IndustryCalcView(String industryCode, String sectorCode, Double pe, Double pb, Double scopeMaketCap, Double scopeAsset, Double scopeEquity, Double growthAsset, Double growthRevenue,
			Double roa, Double roe, Double profitMargin, Double debtEquity, Double currentRatio, Double ebitda) {
		this.industryCode = industryCode;
		this.sectorCode = sectorCode;
		this.pe = pe;
		this.pb = pb;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof IndustryCalcView))
			return false;
		IndustryCalcView castOther = (IndustryCalcView) other;

		return ((this.getIndustryCode() == castOther.getIndustryCode()) || (this.getIndustryCode() != null && castOther.getIndustryCode() != null && this.getIndustryCode().equals(
				castOther.getIndustryCode())))
				&& ((this.getSectorCode() == castOther.getSectorCode()) || (this.getSectorCode() != null && castOther.getSectorCode() != null && this.getSectorCode().equals(castOther.getSectorCode())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getIndustryCode() == null ? 0 : this.getIndustryCode().hashCode());
