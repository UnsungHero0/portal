...
public class CasAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	/**
	 * Used to identify a CAS request for a stateless user agent, such as a remoting protocol client (e.g. Hessian, Burlap, SOAP etc). Results in a more aggressive caching strategy being used, as the
	 * absence of a <code>HttpSession</code> will result in a new authentication attempt on every request.
	 */
