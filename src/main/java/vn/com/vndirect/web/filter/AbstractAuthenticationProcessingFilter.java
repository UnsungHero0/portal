...
public abstract class AbstractAuthenticationProcessingFilter extends GenericFilterBean implements ApplicationEventPublisherAware,
	...
	/*
	 * Delay use of NullRememberMeServices until initialization so that
	 * namespace has a chance to inject the RememberMeServices implementation
	 ...
	 * authentication and should be handled by this filter. If it is an
	 * authentication request, the
	 * {@link #attemptAuthentication(HttpServletRequest, HttpServletResponse)
	 * attemptAuthentication} will be invoked to perform the authentication.
	 ...
	 * {@link #unSuccessfulAuthentication(HttpServletRequest, HttpServletResponse, Authentication)
	 * unSuccessfulAuthentication} method will be invoked</li>
	 * <li>Null is returned, indicating that the authentication process is
	 * incomplete. The method will then return immediately, assuming that the
	 * subclass has done any necessary work (such as redirects) to continue the
	 * authentication process. The assumption is that a later request will be
	 * received by this method where the returned <tt>Authentication</tt> object
	 * is not null.
	 * </ol>
	 */
	 ...
	 *            do a redirect as part of a multi-stage authentication process
	 *            (such as OpenID).
	 * 
	 ...
	 * {@link #successfulAuthentication(HttpServletRequest, HttpServletResponse, Authentication)}
	 * , which may be useful in certain environment (such as Tapestry
	 * applications). Defaults to <code>false</code>.
	 */
