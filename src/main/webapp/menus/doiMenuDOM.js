...
function TPopMenu(label, icon, clickType, clickParam, status, iconId) {
	//+++ TungNQ
	this._iconId = iconId;
	//--- TungNQ
...
function InitMenu() {
	...
	if (this._shadow._create) {
		...
		if (_browser._name == "IE") {
			...
			sh_el.childNodes[0].style.backgroundColor = this._shadow._color;
		...
		if ((iIcon > 0)) {
			...
			switch (this._items[i]._tmpIcon) {
			  ...
			  default:
			  	...
			  	var iconId = this._items[i]._id;
			  	if(this._items[i]._iconId) {
			  		iconId = this._items[i]._iconId;			  		
			  	}
			  	
				this._items[i]._icon = "<td class=\"TIcon" + this._items[i]._parent._index + "\"><img id=\"icon_" + iconId + "\" class=\"TIcon" + this._items[i]._parent._index + "\" src=\"" + this._items[i]._tmpIcon + "\" width=\"16px\" /></td><td>";
			}
		}
		parent._uniqueID++;
			...
			if ((iIcon > 0)) {
				...
				switch (this._items[i]._tmpIcon) {
				  ...
				  default:
					...
					if (isExpandIcon && expandHTML == "") {
						this._items[i]._icon = "<td class=\"TIcon" + this._items[i]._parent._index + "\"><img id=\"icon_" + iconId + "\" class=\"TIcon" + this._items[i]._parent._index + "\" src=\"" + this._items[i]._tmpIcon + "\" width=\"16px\" /></td><td  style=\"padding-right:16px\">";
					} else {
						this._items[i]._icon = "<td class=\"TIcon" + this._items[i]._parent._index + "\"><img id=\"icon_" + iconId + "\" class=\"TIcon" + this._items[i]._parent._index + "\" src=\"" + this._items[i]._tmpIcon + "\" width=\"16px\" /></td><td>";
					}
				}
