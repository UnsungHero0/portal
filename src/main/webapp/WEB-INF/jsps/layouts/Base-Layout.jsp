...
<html xmlns="http://www.w3.org/1999/xhtml" lang="${locale}" xml:lang="${locale}">
	<head>
		...
		<!-- RUh9E1AYq82sZYLPXEj4PXjlH9c -->
		<meta name="alexaVerifyID" content="RUh9E1AYq82sZYLPXEj4PXjlH9c" />
		<meta name="description" content="${pageDescription}" />
		<meta name="keywords" content="${pageKeywords}" />
		<meta http-equiv="Page-Exit"
			content="progid:DXImageTransform.Microsoft.Fade(duration=.3)" />
		...
		<c:forEach var="item" items="${list}">
			<script src="<c:url value='${item}'/>?time=@time_param@" type="text/javascript">
			</script>
		</c:forEach>
	...
	<body>		
		...
		<div id="wrapper">
			...
			<tiles:insertAttribute name="nhapmaCK" />
