...
<div class="recommendBox" style="">
	...
	<div id="recommend-tabs" class="recommendBoxMain">
		...
		<div id="closeStockPick">
			<web:productSubject var="objProdSub" productCode="STOCK_PICK_CLOSE" isUsingCache="false"/>
			<c:out value="${objProdSub['product'].productOverview}"
				escapeXml="false" />
		</div>
		<div id="openStockPick">
			<web:productSubject var="objProdSub" productCode="STOCK_PICK_OPEN" isUsingCache="false"/>
			<c:out value="${objProdSub['product'].productOverview}"
				escapeXml="false" />
		</div>
	</div>
