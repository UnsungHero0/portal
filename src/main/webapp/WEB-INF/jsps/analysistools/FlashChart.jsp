...
<jsp:include page="/WEB-INF/jsps/analysistools/snippet/rt-main-nav.jsp"></jsp:include>
        ...
        <div class="content_small">
            <div class="content_tab ui-tabs-container" style="">
					<form action="" method="post" id="flashForm">
					   <div class="box_taobieudo"><s:text name="web.label.FlashChartAction.enterSymbol"/> 					       
					       <input id="symbol4ChartId" class="input" name="symbol" value="<c:out value="${symbol}" />" />					       
					       <input type="button" class="button" onclick="addSymbol();doLoadSnapshot();" value="<s:text name="web.label.FlashChartAction.drawChart"/>" style="text-transform:uppercase;" />					   
					   </div>
					</form>
...
// -->
	...
	<%--
	<div id="left-col" class="fl" id="snapShotQuickLink">
		<div id="companySnapshot"></div>
	</div>    
    --%>
    </div>
