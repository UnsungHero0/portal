					...
					<div>
						<h2>
							...
							<input name="strToDate" type="text" class="textshortwidth"
								id="fHistoricalPrice_ToDate" style="height: 20px; width: 88px;" />
							<input type="button" class="iButton autoHeight" id="fHistoricalPrice_View"
								value='<s:text name="button.search"/>'>
							<a href="javascript:doDownload();"
								style="text-decoration: none; margin-left: 200px;"><img
