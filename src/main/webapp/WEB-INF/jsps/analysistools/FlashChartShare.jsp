...
<div align="center">
	...
	<table cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td> <span class="cl_blue" style="text-transform:uppercase; font-weight:bold;"> Nhập mã chứng khoán:</span></td>
				...
				<span  class="btn_left_inbox">
					<span class="btn_right_inbox">
						<span class="btn_center_inbox">
							<input type="button" value="Vẽ biểu đồ" style="text-transform:uppercase;" />
						</span>
					</span>
				</span>
			</td>
...
// -->
	...
	<p class="cl_red" style="margin-top:20px;"><s:text name="web.label.FlashChartAction.ChartDescription"></s:text></p>
</div>
