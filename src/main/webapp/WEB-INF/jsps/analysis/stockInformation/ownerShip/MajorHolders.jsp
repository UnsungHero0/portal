...
<input type="hidden" id="fMaijorHolders_companyBreakdown" value='<s:text name="web.label.MaijorHoldersAction.Breakdown">Cơ cấu cổ đông</s:text>'/>
<input type="hidden" id="fMaijorHolders_state" value='<s:text name="web.label.MaijorHoldersAction.StateOwnership">Sở hữu nhà nước</s:text>'/>
<input type="hidden" id="fMaijorHolders_foreign" value='<s:text name="web.label.MaijorHoldersAction.ForeignOwnership">Sở hữu của nhà đầu tư nước ngoài</s:text>'/>
<input type="hidden" id="fMaijorHolders_other" value='<s:text name="web.label.MaijorHoldersAction.Other">Sở hữu khác</s:text>'/>
			...
			<div class="content_tab" style="margin-top: 15px;">
				...
				<div class="box_codong_big">
					<div class="title_tab">
						<div class="bg_righttab">
							<h2>
								<s:text name="si.ownership.majorHolders">Các cổ đông lớn</s:text>
							</h2>
						</div>
					</div>
