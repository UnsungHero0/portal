...
(function() {
	...
	<ul class="n_list_other list_detail_tt_nd"
		id="NewsDetail_ListOtherInDayNews_All_Content" style="display: none;">
		<li class="title bgTitleBar">
			<s:text name="web.label.NewsAction.form.newNews">New News</s:text>
		</li>
	...
	<ul class="n_list_other list_detail_tt_nd"
		id="NewsDetail_ListOtherNews_All_Content" style="display: none;">
		<li class="title bgTitleBar">
			<s:text name="web.label.NewsAction.form.otherNews">Other News</s:text>
		</li>
