...
<div id="content">
	...
	<div class="content_khtc ui-tabs-container" id="tab-1" style="">
        ...
        <web:document var="imgDoc" productCode="BANNER_INSTITUTIONS_INVEST" download="true" />
        <img width="350" class="right" src="${imgDoc['document'].documentUri}" />
                                       
        <!-- content left -->
        <div class="box_left_khtc">
            <web:productSubject var="objProdSub" productCode="INSTITUTIONS_INVEST_INTRO_CONTENT" />
