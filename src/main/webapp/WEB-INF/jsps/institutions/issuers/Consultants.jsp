    ...
    <div class="content_khtc ui-tabs-container" id="tab-3" style="">
        <div class="content_left boardOfExpertsContent">
            <div id="b1" style="display: block;">
                <web:productSubject var="objProdSub" productCode="EXPERT_BOARD_1" />
                <c:out value="${objProdSub['product'].productOverview}"
                    escapeXml="false" />
            </div>

            <div id="b2" style="display: none;">
                <web:productSubject var="objProdSub" productCode="EXPERT_BOARD_2" />
                <c:out value="${objProdSub['product'].productOverview}"
                    escapeXml="false" />
            </div>
            
            <div id="b3" style="display: none;">
                <web:productSubject var="objProdSub" productCode="EXPERT_BOARD_3" />
                <c:out value="${objProdSub['product'].productOverview}"
                    escapeXml="false" />
            </div>
            
            <div id="b4" style="display: none;">
                <web:productSubject var="objProdSub" productCode="EXPERT_BOARD_4" />
                <c:out value="${objProdSub['product'].productOverview}"
                    escapeXml="false" />
            </div>
            
            <div id="b5" style="display: none;">
                <web:productSubject var="objProdSub" productCode="EXPERT_BOARD_5" />
                <c:out value="${objProdSub['product'].productOverview}"
                    escapeXml="false" />
            </div>                                                
        </div>
			...
			<div class="box_listnew">
				...
				<div class="content_small boardOfExperts">
			        <web:productSubject var="objProdSub"
                        productCode="INFO_BOARD_OF_EXPERTS" />
                    <c:out value="${objProdSub['product'].productOverview}"
                        escapeXml="false" />
				</div>
			</div>
