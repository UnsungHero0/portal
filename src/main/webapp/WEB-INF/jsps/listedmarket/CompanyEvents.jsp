...
<input type="hidden" id="fCompanyEvents_currentSymbol" value="VND" />
<input type="hidden" id="localNewsTitle"
	value="<s:text name='home.ir.companyEvents'>Tin doanh nghiệp</s:text>" />
	...
	<div class="content_small">
		<div class="content_tab" id="tab-1">
			...
			<div class="content_ttpt">
				...
				<!-- news content -->
				<div class="ds_news" id="fCompanyEvents_content"
