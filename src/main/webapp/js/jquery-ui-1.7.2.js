...
(function($) {
	...
	function Datepicker() {
		...
		this.dpDiv = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-datepicker-content ui-helper-clearfix ui-corner-all ui-helper-hidden-accessible"></div>')
	}
	$
			.extend(
					Datepicker.prototype,
					{
						...
						_newInst : function(target, inline) {
							...
							return {
								...
								dpDiv : (!inline ? this.dpDiv
										: $('<div class="' + this._inlineClass + ' ui-datepicker ui-widget ui-datepicker-content ui-helper-clearfix ui-corner-all"></div>'))
							}
						},
						...
						_generateHTML : function(inst) {
							...
							var controls = (!inst.inline ? '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery.datepicker._hideDatepicker();">'
									...
									+ "</button>"
									: "");
							var buttonPanel = (showButtonPanel) ? '<div class="ui-datepicker-buttonpane ui-datepicker-content">'
									+ (isRTL ? controls : "")
							...
							for ( var row = 0; row < numMonths[0]; row++) {
								...
								for ( var col = 0; col < numMonths[1]; col++) {
									...
									calender += '<div class="ui-datepicker-header ui-datepicker-header ui-helper-clearfix'
											+ cornerClass
											+ '">'
